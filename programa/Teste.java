...
public class Teste {
	public static void main(String[] args) throws ParseException {
		...
		turmaEx1.setDisciplina(disciplinaEx1);
		turmaEx1.setProfessor(professorEx1);

		Turma turmaEx2 = new Turma();
		turmaEx2.setIdTurma(102);
		turmaEx2.setCapacidade(2);
		turmaEx2.setDisciplina(disciplinaEx2);
		turmaEx2.setProfessor(professorEx2);

		Turma turmaEx3 = new Turma();
		turmaEx3.setIdTurma(103);
		turmaEx3.setCapacidade(1);
		turmaEx3.setDisciplina(disciplinaEx3);
		turmaEx3.setProfessor(professorEx3);

		Turma turmaEx4 = new Turma();
		turmaEx4.setIdTurma(104);
		turmaEx4.setCapacidade(3);
		turmaEx4.setDisciplina(disciplinaEx1);
		turmaEx4.setProfessor(professorEx1);

		Turma turmaEx5 = new Turma();
		turmaEx5.setIdTurma(105);
		turmaEx5.setCapacidade(3);
		turmaEx5.setDisciplina(disciplinaEx2);
		turmaEx5.setProfessor(professorEx2);

		Turma turmaEx6 = new Turma();
		turmaEx6.setIdTurma(106);
		turmaEx6.setCapacidade(3);
		turmaEx6.setDisciplina(disciplinaEx3);
		turmaEx6.setProfessor(professorEx3);

		// ControladorAluno controladorAluno = new ControladorAluno();
		ControladorTurmaAluno controladorTurmaAluno = new ControladorTurmaAluno();
		controladorTurmaAluno.cadastrarAluno(alunoEx1);
		controladorTurmaAluno.cadastrarAluno(alunoEx2);
		controladorTurmaAluno.cadastrarAluno(alunoEx3);
		controladorTurmaAluno.cadastrarAluno(alunoEx4);
		...
		controladorTurmaAluno.cadastrarTurma(turmaEx1);
		controladorTurmaAluno.cadastrarTurma(turmaEx2);
		controladorTurmaAluno.cadastrarTurma(turmaEx3);
		...
		do {
			...
			case "1": // CADASTRAR ALUNO
				...
				controladorTurmaAluno.cadastrarAluno(aluno);
				System.out.println();
				break;
			case "2": // CONSULTAR ALUNO
				...
				System.out.println("Nome: ");
				sc.nextLine();
				controladorTurmaAluno.consultarAluno(sc.nextLine());
				break;
			case "3": // REMOVER ALUNO
				System.out.println("\n> Remover Aluno");
				System.out.println("Nome: ");
				sc.nextLine();
				controladorTurmaAluno.removerAluno(sc.nextLine());
				sc.nextLine();
				break;
			case "4": // LISTAR ALUNOS
				System.out.println("\n> Listar Alunos");
				controladorTurmaAluno.listarAlunos();
				break;
			...
			case "12": // LISTAR DISCIPLINAS
				...
				break;
			case "13": // CONSULTAR TURMA
				System.out.println("\n> Consulta de Turma");
				System.out.println("ID da Turma: ");

				// controladorTurma.consultarTurma(sc.nextInt());
				controladorTurmaAluno.consultarTurma(sc.nextInt());
				break;
			case "14": // LISTAR TURMAS
				System.out.println("\n> Listar Turmas");
				controladorTurmaAluno.listarTurmas();
				break;
			case "15": // ADICIONAR ALUNO À TURMA
				...
				int posTurma = controladorTurmaAluno.buscarTurma(idTurma);
				if (posTurma != -1) {
					int posAluno = controladorTurmaAluno.buscarAluno(nomeAluno);
					if (posAluno != -1) {
						ControladorTurmaAluno alunoTurmaEx1 = new ControladorTurmaAluno();
